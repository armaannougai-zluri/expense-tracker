...
interface AppContextType {
    deleteTransaction: (t: Array<transaction>) => Promise<void>
...
function JoyOrderDashboardTemplate() {
    ...
    return (
        <AppContext.Provider value={{ deleteTransaction, getTransactionList, rows, page }}>
            {
                (openUploadFile == true) ?
...
export { AppContext, JoyOrderDashboardTemplate }; export type { AppContextType };
